...
func (a *Auth) Login(
	...
	//вызов метода нашего провайдера
	...
	//проверка правильный ли пароль нам прислали
	...
	//получение приложения в котором пользователь хочет залогиниться
...
func (a *Auth) RegisterNewUser(ctx context.Context, email string, pass string) (int64, error) {
	...
	//занесение пассхэша в базу данных
